...
import static com.gla.String.Level1.ArrayIndexDemo.generateArrayException;
import static com.gla.String.Level1.ArrayIndexDemo.handleArrayException;
...
import static com.gla.String.Level1.IllegalArgumentDemo.generateException;
import static com.gla.String.Level1.IllegalArgumentDemo.handleException;
...
import static com.gla.String.Level1.NumberFormatDemo.generateNumberException;
import static com.gla.String.Level1.NumberFormatDemo.handleNumberException;
...
public class Runner {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("Exception occurred in generateArrayException()");
        }
        ...
        try {
            generateNumberException(input);
        } catch (Exception e) {
            System.out.println("Exception occurred in generateNumberException()");
        }

        handleNumberException(input);

        //Illegal Argument Exception
        System.out.print("Enter a string: ");
        String inp = sc.nextLine();
        generateException(inp);
        handleException(inp);
        ...
        try {
            ...
            System.out.println("Exception occurred in NullPointerDemo");
        }

        NullPointerDemo.handleException();
